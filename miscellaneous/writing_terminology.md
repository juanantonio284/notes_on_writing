...
In composition *mechanics* refers to the appearance of words, to how they are spelled or arranged on
paper. The fact that the first word of a paragraph is usually indented, for example, is a matter of
mechanics. 
...
if not the only way of solving a problem, an economic and efficient way.
...
* "She dresses in a beautiful manner" is a lapse in style
    - The sentence breaks no rule of grammar or of usage, but it is not effective (assuming that the
      writer wants to stress the idea of "beauty"). The structure slurs the emphasis, which should
      be on the key word (*she*) and which should close the statement
        - "She dresses beautifully." is a fully closed idea focused on how she dresses
        - "She dresses in a beautiful manner" still leaves things it open to describe the manner in
           which she dresses
    - Style is less reducible to rule, and more open to argument. No one can prove "She dresses in a
...
* Kane, Thomas S. *The Oxford Essential Guide to Writing* (2000 printing, ISBN 0425176401)
